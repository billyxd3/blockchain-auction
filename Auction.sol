...
contract AuctionFactory {
    ...
    function getDeployedAuctions public view returns(Auction[]) {
...
contract Auction {
    ...
    constructor(address creator) {
        ...
        endBlock = startBlock + 40320; // secondsPerWeek / timeToMineBlock => 604800 / 15 = 40320
        ipfsHash = "";
        bidIncrement = 100;
    }
    ...
    function placeBid() public payable notOwner afterStart beforeEnd {
        ...
        if (currentBid <= bids[highestBidder]) {
            highestBindingBid = Math.min(currentBid + bidIncrement, bids[highestBidder]);
        } else {
    ...
    function finalizeAuction() public {
        ...
        if (auctionState == State.Cancelled) { //auction was cancelled
            ...
            if(msg.sender == owner) { // this is the owner
                ...
                } else { //this is neither the owner nor highestBidder
                    recipient = payable(msg.sender);
                    value = bids[msg.sender];
                }
